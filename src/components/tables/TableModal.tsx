...
export const TableModal: React.FC<TableModalProps> = ({
  ...
  /* Manejo de Cantidades en el Pedido */
        ...
        {table.status === 'AVAILABLE' && currentItems.length === 0 ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
            ...
            <p className="text-sm text-gray-500 mb-6 max-w-sm">
              Abre la mesa para empezar a añadir platos y tomar el pedido de los clientes.
            </p>
            <button
              onClick={handleOpenTableAction}
          ...
          /* Vista Mesa Ocupada / Edición de Pedido */
          <div className="flex-1 overflow-hidden flex flex-col md:flex-row">
            
            {/* Lista de Consumos Actuales */}
            <div className="w-full md:w-1/2 p-4 border-r border-gray-200 overflow-y-auto flex flex-col">
              <h3 className="font-bold text-gray-700 mb-3 text-base">Pedido Actual</h3>
              {currentItems.length === 0 ? (
                <p className="text-sm text-gray-400 italic my-auto text-center">
            ...
            {/* Catálogo de Selección de Platos */}
